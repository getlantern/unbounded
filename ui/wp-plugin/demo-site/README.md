...
`unbounded-by-lantern.zip`, activates it, and lands on a page with the widget embedded.
...
| `build.sh` | Assembles `dist/`, generating `unbounded-by-lantern.zip` from the plugin source. |
